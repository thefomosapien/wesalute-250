...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/wesaluteofficial/",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/wesaluteofficial/",
    icon: (
      <svg viewBox="0 0 24 24" width={18} height={18} fill="currentColor" aria-hidden>
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/wesalute",
    icon: (
      <svg viewBox="0 0 24 24" width={18} height={18} fill="currentColor" aria-hidden>
...
export function Footer() {
  return (
    <footer
      className="px-8 py-10 bg-slateDeep"
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            />
            <div
              className="font-mono text-[9px] tracking-[0.26em] text-cream uppercase"
              style={{ opacity: 0.4 }}
            >
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            <div className="flex items-center gap-4">
              {socialLinks.map(({ label, href, icon }) => (
                <a
                  ...
                  className="text-cream opacity-50 hover:opacity-100 hover:text-gold transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
            ...
            <div
              className="flex items-center gap-2 font-mono text-[9px] tracking-[0.24em] text-cream uppercase"
              style={{ opacity: 0.35 }}
            >
              <span>1776</span>
              <Star size={7} color="#FFC43E" />
              <span>2026</span>
            </div>
          </div>
        </div>
